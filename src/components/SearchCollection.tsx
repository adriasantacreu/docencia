    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
      ...
      <div class="col-span-3 sm:col-span-1">
        <div class="sticky top-24 mt-7">
          {/* Search Bar */}
          <SearchBar onSearchInput={onSearchInput} query={query} setQuery={setQuery} placeholderText={`Cerca ${entry_name}`} />
          {/* Tag Filters */}
          <div class="relative flex flex-row justify-between w-full"><p class="text-sm font-semibold uppercase my-4 text-black dark:text-white">Etiquetes</p>
            {filter().size > 0 && (
              <button
        ...
        <div class="flex flex-col">
          ...
          <div class='flex justify-between flex-row mb-2'>
            <div class="text-sm uppercase">
              MOSTRANT {collection().length} DE {data.length} {entry_name.toUpperCase()}
            </div>
